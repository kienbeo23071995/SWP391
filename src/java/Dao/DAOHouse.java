...
import Model.House_Ratings;
import Model.InforOwner;
import Model.NewsPostHouse;
...
//                f.setFullname(rs.getString(5));
    ...
    public void editFeedbackSystem(String comment, int ID) {
    ...
    public static void main(String[] args) {
        ...
        List<House> list = dao.getAllHouse(null, null, null, null, null, null, "Mễ Trì", "0");
...
//        List<House> list = dao.getHouseByAddress("Liêm", "0");
    ...
    public void updateDetail(House_Details detail) {
        ...
        try {
            ...
            ps.setInt(4, detail.getHouse_Direction_ID());
            ps.setInt(5, detail.getHouse_ID());
            ps.executeUpdate();
        } catch (Exception e) {
            Logger.getLogger(DAOAccount.class.getName()).log(Level.SEVERE, null, e);
        }
