...
public class ViewProfileController extends HttpServlet {
    ...
    throws ServletException, IOException {
        request.getRequestDispatcher("ViewProfileUser.jsp").forward(request, response);
    } 
    ...
    throws ServletException, IOException {
        ...
        //get value of account ID request by user
        int accountID = Integer.parseInt(request.getParameter("accountID"));
        
        //get account of user by id
       DAOAccount DAcc = new DAOAccount();
        Account acc = DAcc.getAccountById(accountID);
