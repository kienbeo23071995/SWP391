...
public class Controller_Home extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (districtId == null || districtId.trim().isEmpty() || districtId.equals("0")) {
            districtId = null;
        }
        ...
        if (districtId != null) {
            request.setAttribute("districtId", Integer.parseInt(districtId));           
        }
        else {
            request.setAttribute("districtId", 0);    
        }
        if (categoryID != null) {
        ...
        request.setAttribute("areaRange", minArea + "-" + maxArea);
