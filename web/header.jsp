    ...
    <body>
                        ...
                        <div class="user-welcome clearfix js-reload-html-header"><a class="welcome-text"
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenu2">
                                    ...
                                    <li><a class="dropdown-menu-item quan-ly-tin-dang" rel="nofollow" href="manager"><i class="fas fa-tasks"></i> Quản lý tin đăng nhà</a></li>
        ...
        <nav id="navbar-menu" class="">
            <ul id="menu-main-menu" class="container-menu clearfix level-1">
                ...
                <li class="navbar_item clearfix"><a href="homeController">Hướng dẫn</a></li>
